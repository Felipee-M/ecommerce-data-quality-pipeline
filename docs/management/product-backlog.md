...
| PB-016 | Create metrics API with FastAPI | Medium | Sprint 6 | Pending |
| PB-017 | Create API tests | Medium | Sprint 6 | Pending |
| PB-018 | Build Power BI dashboard | High | Sprint 7 | Pending |
| PB-019 | Add CI workflow with GitHub Actions | Medium | Sprint 8 | Pending |
| PB-020 | Publish project case study in portfolio | High | Sprint 9 | Pending |